...
export class LoginPage extends BasePage {
  ...
  readonly emailExistsError = this.page.getByText("Email Address already exist!");
  ...
  // Trả về HTML5 validity của input email signup (data getter, không phải assertion)
  // Dùng cho TC_AUTH_07/08: email sai format bị browser chặn submit
  async getSignupEmailValidity(): Promise<boolean> {
    return this.signupEmailInput.evaluate((el: HTMLInputElement) => el.validity.valid);
  }
}
